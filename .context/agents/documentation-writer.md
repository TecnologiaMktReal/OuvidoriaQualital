...
- [`UseCompositionReturn`](client\src\hooks\useComposition.ts#L4) (interface)
- [`UseCompositionOptions`](client\src\hooks\useComposition.ts#L13) (interface)
- [`UserProfile`](client\src\_core\hooks\useAuth.ts#L5) (interface)
